# ============================================================
# main_v21.py — Trading Bot Trading Bot v2.1
#
# AMAÇ:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Trading Bot v2.1 — Long + Short Algo Trading"
    )
...
def main() -> None:
    ...
    logger.info("=" * 60)
    logger.info(f"🚀 Trading Bot {VERSION_LABEL} — Long + Short Bot Başlatılıyor")
    logger.info("=" * 60)
